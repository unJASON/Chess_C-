...
#ifdef DEBUG
	str = string("{\"requests\":[{\"x\":-1,\"y\":-1},{\"x\":5,\"y\":9},{\"x\":-1,\"y\":-1},{\"x\":5,\"y\":10},{\"x\":4,\"y\":9},{\"x\":4,\"y\":8},{\"x\":4,\"y\":11}],\"responses\":[{\"x\":4,\"y\":10},{\"x\":3,\"y\":9},{\"x\":5,\"y\":11},{\"x\":2,\"y\":8},{\"x\":1,\"y\":7},{\"x\":0,\"y\":6}]}");
#else
	getline(cin, str);
#endif // DEBUG
	RecoverBoard(str);
